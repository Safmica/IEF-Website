            ...
            <div class="col-lg-3 col-md-6 mb-4" data-aos="fade-up">
                <div class="card competition-card">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ url('register-debate') }}" class="btn btn-details">Lihat Details</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 mb-4" data-aos="fade-up">
                <div class="card competition-card">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ url('register-speech') }}" class="btn btn-details">Lihat Details</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 mb-4" data-aos="fade-up">
                <div class="card competition-card">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ url('register-scrabble') }}" class="btn btn-details">Lihat Details</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 mb-4" data-aos="fade-up">
                <div class="card competition-card">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ url('register-newscasting') }}" class="btn btn-details">Lihat Details</a>
                    </div>
                </div>
            </div>
