...
<head>
    ...
    <title>Register Newscasting - IEF 2024</title>
    ...
    <script src="{{ asset('js/checkNotRegisteredNewscasting.js') }}"></script>
</head>
<body class="bg-black">
<header>
...
<style>
    body {
      background: linear-gradient(rgba(255, 255, 255, 0.8), rgba(255, 255, 255, 0.8)), url('https://image.utoimage.com/preview/cp924216/2020/08/202008006945_500.jpg');
          ...
          <div class="card-body">
            ...
            <form id="registrationForm">
              ...
              <div class="checkbox-label mb-4">
                ...
                <label for="agree_participation">I agree to participate in the entire selection process until the end of the Newscasting Competition International English Festival 2024.</label>
              </div>
              <div class="checkbox-label mb-4">
...
<script>
  document.getElementById('registrationForm').addEventListener('submit', function (event) {
      ...
      if (user) {
          ...
          // Ubah user.newscasting menjadi "Verification"
          user.newscasting = "Verification";
