...
<head>
    ...
    <title>Register Scrabble - IEF 2024</title>
    ...
    <script src="{{ asset('js/checkNotRegisteredScrabble.js') }}"></script>
</head>
<body class="bg-black">
<header>
...
<style>
    body {
      background: linear-gradient(rgba(255, 255, 255, 0.8), rgba(255, 255, 255, 0.8)), url('https://media.istockphoto.com/id/502558269/photo/scrabble-letters.jpg?s=612x612&w=0&k=20&c=12UjZ8LhHljnCZ9Hg1XS9wbK1h9sKu5FhGnCFwzXRL4=');
    ...
    <script>
      document.getElementById('registrationForm').addEventListener('submit', function (event) {
          ...
          if (user) {
              ...
              // Ubah user.scrabble menjadi "Verification"
              user.scrabble = "Verification";
