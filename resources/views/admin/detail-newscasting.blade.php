                            ...
                            <table id="datatablesSimple" class="text-dark">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ $newscasting->photo }}" target="_blank" class="btn btn-primary">Photo</a>
                                        </td>
                                        <td>
                                            <a href="{{ $newscasting->id_student_card }}" target="_blank" class="btn btn-primary">ID Student Number</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
