        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4 text-dark freshman">Detail Data Newscasting</h1>
                            ...
                            <table id="datatablesSimple" class="text-dark">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ $newscasting->photo }}" target="_blank" class="btn btn-primary">Buka Bukti Pembayaran</a>
                                        </td>
                                        <td>
                                            <a href="{{ $newscasting->id_student_card }}" target="_blank" class="btn btn-primary">Buka Bukti Pembayaran</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
